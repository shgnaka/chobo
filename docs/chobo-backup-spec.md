...
実装境界は [`docs/chobo-backup-codec-interface.md`](/home/shgnaka/chobo/docs/chobo-backup-codec-interface.md) に分離する。
...
- 復元導線は深い管理画面に置く
- テスト観点は [`docs/chobo-backup-test-cases.md`](/home/shgnaka/chobo/docs/chobo-backup-test-cases.md) に分離する
