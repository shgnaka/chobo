...
class FlutterSecureStorageBackupMasterKeyStore {
  FlutterSecureStorageBackupMasterKeyStore({
    FlutterSecureStorage? storage,
    this.storageKey = _defaultStorageKey,
  }) : _storage = storage ?? const FlutterSecureStorage();

  static const String _defaultStorageKey = 'chobo_backup_master_key_v1';
